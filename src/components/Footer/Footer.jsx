...
import { Box, Button, Grid, InputBase, Link, List, ListItem, Paper, Typography } from '@mui/material'
  ...
  return (
   <Box sx={styles.footer}>
        <Grid container columns={{xs:4,sm:8,md:12}} sx={styles.gridWrapper}>
            ...
            <Grid item xs={6} sm={4} md={3}>
                <Box>
                    <Typography variant='h3' sx={styles.linkTitle}>links</Typography>
                    <List>
           ...
           <Grid item xs={6} sm={4} md={4} sx={styles.emailBlock}>
                <Box sx={styles.subscribeFooter}>
                    ...
                    Lorem ipsum dolor sit amet, <Link sx={{color:'#777FEB'}}>consectetur adipiscing </Link> elit.consectetur. psum dolor sit am psum dolor sit am.{' '}
                    </Typography>
